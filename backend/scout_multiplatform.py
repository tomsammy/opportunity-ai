...
def crawl_all_8_scout_platforms() -> list:
    ...
    multiplatform_seeds = [
        ...
        {
            "id": "scout-tiktok-01",
            "title": "TikTok & YouTube STEM Youth Innovator Fellowship 2026",
            "category": "Fellowship",
            "funding_amount": "$25,000 USD Stipend + Equipment & Lab Grant",
            "deadline": "December 01, 2026",
            "eligibility": "Youth Innovators Aged 18-28 in AI & STEM",
            "source_name": "TikTok & YouTube (Scout Intelligence)",
            "apply_url": "https://newsroom.tiktok.com",
            "published_at": datetime.now().strftime("%Y-%m-%d"),
            "region": "Global",
            "summary": "Fellowship supporting young innovators communicating complex AI, science, and engineering breakthroughs on digital video platforms.",
            "contact_email": "stem-fellows@tiktok.com",
            "scout_score": 96,
            "platform": "TikTok"
        },
        {
            "id": "scout-yt-accel-01",
            "title": "YouTube & Google for Startups Accelerator 2026 ($150,000 Equity-Free Funding)",
            "category": "Accelerator",
            "funding_amount": "$150,000 USD Equity-Free Funding + Cloud Credits",
            "deadline": "November 15, 2026",
            "eligibility": "Early stage tech founders building AI, Media & Developer tools",
            "source_name": "YouTube (Google for Startups)",
            "apply_url": "https://startup.google.com/accelerator/",
            "published_at": datetime.now().strftime("%Y-%m-%d"),
            "region": "Global",
            "summary": "Premier 10-week cohort providing direct equity-free funding, technical mentorship, and product support from Google & YouTube engineering leaders.",
            "contact_email": "accelerator-apply@google.com",
            "scout_score": 98,
            "platform": "YouTube"
        },
        {
            "id": "scout-tiktok-comp-01",
            "title": "Global Student AI & Tech Innovation Competition 2026 ($50,000 Prize Pool)",
            "category": "Competition",
            "funding_amount": "$50,000 USD Cash Prizes + Investor Pitch Day",
            "deadline": "October 20, 2026",
            "eligibility": "Undergraduate & Graduate Student Developers",
            "source_name": "TikTok (Scout Innovation Competition)",
            "apply_url": "https://tiktok.com",
            "published_at": datetime.now().strftime("%Y-%m-%d"),
            "region": "Worldwide",
            "summary": "Global student hackathon calling for AI software solutions addressing education, climate, and accessibility challenges.",
            "contact_email": "hackathon@tiktok.com",
            "scout_score": 95,
            "platform": "TikTok"
        },
        {
            "id": "scout-yt-intern-01",
            "title": "YouTube & ByteDance Global Graduate Software Engineering Internship 2027",
            "category": "Internship",
            "funding_amount": "Fully Funded ($8,500/month Stipend + Housing + Flights)",
            "deadline": "January 30, 2027",
            "eligibility": "Bachelor's, Master's & PhD Students in Computer Science / Data",
            "source_name": "YouTube & ByteDance Careers",
            "apply_url": "https://careers.google.com/students/",
            "published_at": "2026-08-07",
            "region": "USA / UK / Zurich / Singapore",
            "summary": "12-week summer software engineering and machine learning research internship building large-scale video processing and recommendation systems.",
